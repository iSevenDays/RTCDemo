...
#ifndef QUICKBLOX_AUDIO_DEVICE_IOS_AUDIO_DEVICE_IOS_H_
#define QUICKBLOX_AUDIO_DEVICE_IOS_AUDIO_DEVICE_IOS_H_
...
#include "quickblox_audio_data_sink.h"
...
namespace webrtc {
    ...
    class QBAudioDeviceIOS : public ::webrtc::AudioDeviceGeneric {
    public:
        QBAudioDeviceIOS();
        ~QBAudioDeviceIOS();
        
        //******************************************************************************
        // Add/Remove a sink that will receive the audio data
        void AddSink(QBAudioDataSinkInterface* sink);
        void RemoveSink(QBAudioDataSinkInterface* sink);
    ...
    private:
        ...
        ::webrtc::AudioParameters playout_parameters_;
        ::webrtc::AudioParameters record_parameters_;
        ...
        rtc::scoped_ptr<::webrtc::FineAudioBuffer> fine_audio_buffer_;
        ...
        std::list<QBAudioDataSinkInterface*> sinks_;
    };    
}

#endif  // QUICKBLOX_AUDIO_DEVICE_IOS_AUDIO_DEVICE_IOS_H_
