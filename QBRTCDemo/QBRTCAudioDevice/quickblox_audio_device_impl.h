...
#ifndef quickblox_audio_device_impl_h
#define quickblox_audio_device_impl_h
...
namespace webrtc {
    ...
    class QBAudioDeviceModuleImpl : public webrtc::AudioDeviceModule {
    public:
        enum PlatformType {
        ...
        QBAudioDeviceModuleImpl(const int32_t id, const AudioLayer audioLayer);
        virtual ~QBAudioDeviceModuleImpl();
        ...
        int32_t RegisterEventObserver(webrtc::AudioDeviceObserver* eventCallback) override;
        ...
        int32_t StartRawOutputFileRecording(
                                            const char pcmFileNameUTF8[webrtc::kAdmMaxFileNameSize]) override;
        ...
        webrtc::AudioDeviceBuffer* GetAudioDeviceBuffer() { return &_audioDeviceBuffer; }
        
        //TODO: Moved forom provate 
    ...
    private:
        ...
        webrtc::AudioDeviceObserver* _ptrCbAudioDeviceObserver;
...
#endif /* quickblox_audio_device_impl_h */
