//
//  quickblox_audio_device_ios.mm
//  QuickbloxWebRTC
//
//  Created by Andrey Ivanov on 22/12/15.
...
#define LOGI() LOG(LS_INFO) << "QBAudioDeviceIOS::"
...
#define LOG_IF_ERROR(error, message)                    \
    ...
    EXCLUSIVE_LOCKS_REQUIRED(g_lock) {
        ...
        QBAudioDeviceIOS::QBAudioDeviceIOS()
        ...
        void QBAudioDeviceIOS::AttachAudioBuffer(AudioDeviceBuffer* audioBuffer) {
        ...
        int32_t QBAudioDeviceIOS::Terminate() {
        ...
        int32_t QBAudioDeviceIOS::InitPlayout() {
        ...
        int32_t QBAudioDeviceIOS::InitRecording() {
        ...
        int32_t QBAudioDeviceIOS::StartPlayout() {
        ...
        int32_t QBAudioDeviceIOS::StopPlayout() {
        ...
        int32_t QBAudioDeviceIOS::StartRecording() {
        ...
        int32_t QBAudioDeviceIOS::StopRecording() {
        ...
        int32_t QBAudioDeviceIOS::SetLoudspeakerStatus(bool enable) {
        ...
        int32_t QBAudioDeviceIOS::GetLoudspeakerStatus(bool& enabled) const {
        ...
        int32_t QBAudioDeviceIOS::PlayoutDelay(uint16_t& delayMS) const {
            
            delayMS = kFixedPlayoutDelayEstimate;
            return 0;
        }
        
        int32_t QBAudioDeviceIOS::RecordingDelay(uint16_t& delayMS) const {
            
            delayMS = kFixedRecordDelayEstimate;
            return 0;
        }
        
        int QBAudioDeviceIOS::GetPlayoutAudioParameters(AudioParameters* params) const {
        ...
        int QBAudioDeviceIOS::GetRecordAudioParameters(AudioParameters* params) const {
        ...
        void QBAudioDeviceIOS::UpdateAudioDeviceBuffer() {
        ...
        void QBAudioDeviceIOS::RegisterNotificationObservers() {
        ...
        void QBAudioDeviceIOS::UnregisterNotificationObservers() {
        ...
        void QBAudioDeviceIOS::SetupAudioBuffersForActiveAudioSession() {
            ...
            const size_t required_playout_buffer_size =
            ...
            const size_t data_byte_size = record_parameters_.GetBytesPerBuffer();
            ...
            audio_buffer->mNumberChannels = static_cast<UInt32>(record_parameters_.channels());
            audio_buffer->mDataByteSize = static_cast<UInt32>(data_byte_size);
            audio_buffer->mData = record_audio_buffer_.get();
        }
        
        bool QBAudioDeviceIOS::SetupAndInitializeVoiceProcessingAudioUnit() {
            ...
            if (result != noErr) {
                ...
                DisposeAudioUnit();
                LOG(LS_ERROR) << "Failed to enable input on input scope of input element: " << result;
                return false;
            }
            ...
            while (result != noErr) {
                ...
                LOG(LS_ERROR) << "Failed to initialize the Voice-Processing I/O unit: " << result;
        ...
        bool QBAudioDeviceIOS::RestartAudioUnitWithNewFormat(float sample_rate) {
            ...
            LOG_AND_RETURN_IF_ERROR(AudioUnitUninitialize(vpio_unit_),
        ...
        bool QBAudioDeviceIOS::InitPlayOrRecord() {
        ...
        void QBAudioDeviceIOS::ShutdownPlayOrRecord() {
        ...
        void QBAudioDeviceIOS::DisposeAudioUnit() {
        ...
        OSStatus QBAudioDeviceIOS::RecordedDataIsAvailable(
                                                           void* in_ref_con,
            ...
            QBAudioDeviceIOS* audio_device_ios = static_cast<QBAudioDeviceIOS*>(in_ref_con);
            return audio_device_ios->OnRecordedDataIsAvailable(
                                                               io_action_flags, in_time_stamp, in_bus_number, in_number_frames);
        }
        
        OSStatus QBAudioDeviceIOS::OnRecordedDataIsAvailable(
                                                             AudioUnitRenderActionFlags* io_action_flags,
                                                             const AudioTimeStamp* in_time_stamp,
                                                             UInt32 in_bus_number,
                                                             UInt32 in_number_frames) {
            ...
            for (auto* sink : sinks_) {
                sink->OnData(io_data, application_format_, in_number_frames, true);
            }
        ...
        OSStatus QBAudioDeviceIOS::GetPlayoutData(
                                                  void* in_ref_con,
                                                  AudioUnitRenderActionFlags* io_action_flags,
                                                  const AudioTimeStamp* in_time_stamp,
                                                  UInt32 in_bus_number,
        ...
        OSStatus QBAudioDeviceIOS::OnGetPlayoutData(
                                                    AudioUnitRenderActionFlags* io_action_flags,
                                                    UInt32 in_number_frames,
                                                    AudioBufferList* io_data) {
        ...
        //add / remove sinks
        void QBAudioDeviceIOS::AddSink(QBAudioDataSinkInterface* sink) {
        ...
        void QBAudioDeviceIOS::RemoveSink(QBAudioDataSinkInterface* sink) {
